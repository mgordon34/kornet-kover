...
- `backend/internal/sports/` data-first sport config registry map (NBA, MLB, WNBA)
...
- Sport-specific config is centralized in `sports.Configs` and accessed by sport key
